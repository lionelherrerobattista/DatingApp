...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<PagedList<MemberDto>> GetMembersAsync(UserParams userParams)
        {
            ...
            // build our query according to info in UserParams
        ...
        {
            return await _context.SaveChangesAsync() > 0; // false if nothing is saved
        }

        public void Update(AppUser user)
        {
            _context.Entry(user).State = EntityState.Modified; // tells EF that the entity has been updated.
        }
    }
}